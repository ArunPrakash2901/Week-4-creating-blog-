...
df <- read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2024/2024-01-23/english_education.csv')
...
```{r}
data_dict <- read_csv("data/key variables.csv")
